(function () {
    ...
    postcodeUtils.param = function (a) {
        ...
        postcodeUtils.isIOSWebview = function (a) {
            for (var b = ["version/7", "version/8", "version/9", "version/10", "version/11", "version/12", "version/13", "version/14", "version/15"], c = 0, d = 0, e = b.length; d < e; d++)
                a.indexOf(b[d]) === -1 && c++;
            return c === b.length || checkWebviewCustomUA(a)
        }
        ,
        postcodeUtils.isDaumapps = function (a) {
            for (var b = ["daumapps"], c = 0, d = 0, e = b.length; d < e; d++)
                a.indexOf(b[d]) > -1 && c++;
            return c === b.length
        }
        ,
        postcodeUtils.isMobileChrome = function (a) {
            for (var b = ["crios", "chrome"], c = 0, d = 0, e = b.length; d < e; d++)
                a.indexOf(b[d]) > -1 && c++;
            return c > 0
        }
        ,
        ...
        a.frame = function () {
            ...
            function b(a) {
                ...
                return f.userAgent.os.ios && f.isIOSWebview(f.userAgent.ua_string) && (c = {
                    ...
                    b.setAttribute("title", "우편번호서비스 레이어 프레임"),
                    b.style.cssText = f.getStringByOptions(c, ":", ";"),
                    b
            }
            function e(c, d) {
                if (null === p)
                    return alert("POPUP URL을 셋팅해 주세요.");
                var e = a(c)
                    , g = b(c);
                return e.id = j.setId("layer", c.viewerNo),
                    g.src = "about:blank",
                    e.appendChild(g),
                    h.append(d, e),
                ...
                e.document.write(s(c)),
                    ...
                    j.setReady(e, function (f, i) {
                        if ("reload" === f) {
                            ...
                            "search" === f ? c.onSearch !== g.EMPTY_FUNCTION && c.onSearch(i) : "resize" === f ? c.onResize !== g.EMPTY_FUNCTION && (c.onResize(i),
                                h.adjustLowIE(e, a, b, j.getId("viewerFrame", c.viewerNo), i.width, i.height)) : "done" === f && c.onComplete !== g.EMPTY_FUNCTION && setTimeout(function () {
                                    c.onComplete(i),
                                        c.autoClose && (h.IE11CompatibleBugFix(e),
                                            h.remove(d, b),
                ...
                try {
                    ...
                    if (d) {
                        ...
                        k ? (d.removeChild(k),
                            ...
                            f.innerHTML = e,
                            d.appendChild(f)) : (f = c.document.createElement("title"),
                                f.innerHTML = e,
                        ...
                        if (b.onComplete(d),
                            ...
                            if (b.onClose !== g.EMPTY_FUNCTION) {
                                ...
                                c && clearInterval(c.data.closeCallbackTimer),
                                    a.close(),
                                    b.onClose(g.POPUP_CLOSE_STATE.COMPLETE)
                            } else
                                a.close()
    ...
    !function (a, b, c, d, e) {
        ...
        function g(a, b) {
            ...
            if (b) {
                var d = b.q
                    , e = !0;
                d && "string" == typeof d && "" !== o.trim(d) && (c = e === !0 ? o.extend(a, {
        ...
        function l(a) {
            ...
            if (c.width = d.value,
                ...
                "string" == typeof c.minWidth ? isNaN(c.minWidth) ? c.minWidth = p.MIN_WIDTH : c.minWidth = o.clamp(parseInt(c.minWidth, 10), 0, p.MIN_WIDTH) : "number" == typeof c.minWidth ? c.minWidth = o.clamp(c.minWidth, 0, p.MIN_WIDTH) : c.minWidth = p.MIN_WIDTH,
                c.onComplete && "function" == typeof c.onComplete && c.onComplete !== p.EMPTY_FUNCTION ? c.onComplete = c.onComplete : c.oncomplete && "function" == typeof c.oncomplete && c.oncomplete !== p.EMPTY_FUNCTION ? c.onComplete = c.oncomplete : (c.onComplete = p.EMPTY_FUNCTION,
                    c.oncomplete = p.EMPTY_FUNCTION,
                    c.isViewerMode = !0),
                c.onResize && "function" == typeof c.onResize && c.onResize !== p.EMPTY_FUNCTION ? c.onResize = c.onResize : c.onresize && "function" == typeof c.onresize && c.onresize !== p.EMPTY_FUNCTION ? c.onResize = c.onresize : (c.onResize = p.EMPTY_FUNCTION,
                    c.onresize = p.EMPTY_FUNCTION),
                c.onClose && "function" == typeof c.onClose && c.onClose !== p.EMPTY_FUNCTION ? c.onClose = c.onClose : c.onclose && "function" == typeof c.onclose && c.onclose !== p.EMPTY_FUNCTION ? c.onClose = c.onclose : (c.onClose = p.EMPTY_FUNCTION,
                    c.onclose = p.EMPTY_FUNCTION),
                c.onSearch && "function" == typeof c.onSearch && c.onSearch !== p.EMPTY_FUNCTION ? c.onSearch = c.onSearch : c.onsearch && "function" == typeof c.onsearch && c.onsearch !== p.EMPTY_FUNCTION ? c.onSearch = c.onsearch : (c.onSearch = p.EMPTY_FUNCTION,
                    c.onsearch = p.EMPTY_FUNCTION),
                "boolean" != typeof c.autoMappingJibun && (c.autoMappingJibun = !0),
                "boolean" != typeof c.autoMappingRoad && (c.autoMappingRoad = !0),
                "boolean" != typeof c.autoMapping && (c.autoMapping = !0),
                "boolean" == typeof a.autoMapping && (c.autoMappingJibun = c.autoMappingRoad = c.autoMapping),
            ...
            "boolean" != typeof c.allAddr && (c.allAddr = !1),
                ...
                "boolean" != typeof c.useBannerLink && (c.useBannerLink = !0),
                this._opt_ = c
        }
        var m = c.daum.postcode;
        if (!m)
            return void alert("[우편번호 서비스] API 로딩 오류가 발생하였습니다. 확인 바랍니다. 지속적인 오류 발생시 ( https://github.com/daumPostcode/QnA/issues ) 이슈 등록 부탁드립니다.");
        var n = function (a) {
        ...
        n(!0, "[우편번호 서비스 로딩 오류] API 로딩시 허용되지 않는 파라미터가 감지되었습니다. 사이트 관리자(개발자)분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.");
        var o = b
            , p = a.CONT
            , q = a.MODEL
            , r = a.viewUtils
            , s = a.frame
            , t = a.themePreprocessor
            , u = "http:" !== a.CONT.PROTOCOL
            , v = (u ? "https:" : "http:") + "//postcode.map.daum.net/search"
            , w = encodeURIComponent(p.PROTOCOL + "//" + e.host)
            , x = encodeURIComponent(e.pathname)
            , y = ""
            , z = v + "?origin=" + w;
        s.init(z, x, y),
            l.prototype = {
                open: function (a) {
                    if (!n(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
