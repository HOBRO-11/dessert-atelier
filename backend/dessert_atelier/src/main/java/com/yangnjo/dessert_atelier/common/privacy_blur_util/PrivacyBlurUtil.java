package com.yangnjo.dessert_atelier.common.privacy_blur_util;
...
public class PrivacyBlurUtil {
    ...
    public static Destination maskDestination(Destination destination) {
        if (destination == null) {
            return destination;
        }
        return new Destination(maskAddress(destination.getPostCode()), "*******", maskName(destination.getReceiver()),
