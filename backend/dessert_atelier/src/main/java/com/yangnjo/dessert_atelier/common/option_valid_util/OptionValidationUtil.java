...
public class OptionValidationUtil {
    ...
    public static boolean isAvailable(List<Long> optionIds, Map<Long, ProductOptionSimpleDto> optionSimpleMap,
    ...
    public static void checkValid(List<Long> optionIds, Map<Long, ProductOptionSimpleDto> optionSimpleMap,
            Map<Long, DpSimpleDto> DpSimpleMap,
            List<Long> presetTableDpIds) {
    ...
    private static Long getDpId(List<Long> optionIds, Map<Long, ProductOptionSimpleDto> osds) {
        return 0L;
    }

    private static Integer getDpOptionLayer(List<Long> optionIds, Map<Long, ProductOptionSimpleDto> osds,
